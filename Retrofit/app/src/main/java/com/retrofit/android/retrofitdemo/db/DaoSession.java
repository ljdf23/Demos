...
import com.retrofit.android.retrofitdemo.db.TermsAndConditionsDao;
...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig catalogsDaoConfig;
    private final DaoConfig termsAndConditionsDaoConfig;
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        catalogsDaoConfig = daoConfigMap.get(CatalogsDao.class).clone();
        catalogsDaoConfig.initIdentityScope(type);

        termsAndConditionsDaoConfig = daoConfigMap.get(TermsAndConditionsDao.class).clone();
        termsAndConditionsDaoConfig.initIdentityScope(type);
        ...
        catalogsDao = new CatalogsDao(catalogsDaoConfig, this);
        termsAndConditionsDao = new TermsAndConditionsDao(termsAndConditionsDaoConfig, this);
        ...
        registerDao(Catalogs.class, catalogsDao);
        registerDao(TermsAndConditions.class, termsAndConditionsDao);
    }
    ...
    public void clear() {
        ...
        catalogsDaoConfig.clearIdentityScope();
        termsAndConditionsDaoConfig.clearIdentityScope();
    }
